...
if ( ! defined( "XC_PLUGIN_VERSION" ) ) 	define( "XC_PLUGIN_VERSION",  "2.6.6");
...
if ( is_plugin_active( 'xllentech-calendar-pro/xllentech-calendar-pro.php' ) ) {
	...
	$class_xllentech_today = ABSPATH . 'wp-content/plugins/xllentech-calendar-pro/public/partials/class-xllentech-islamic-today-pro.php';
