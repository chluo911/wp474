...
class Xllentech_English_Islamic_Calendar_Admin {
	...
	function admin_header_menu( $page_title ) {
		...
		<h2 class="nav-tab-wrapper">
			<a class="<?php 
				_e( $options_class ); 
					?>" href="<?php _e( esc_url( admin_url( $menu_path .'page=xllentech_options') ) ); ?>">
			<?php esc_attr_e( 'Options', 'xllentech-calendar' ); ?></a>
			
			<a class="<?php 
				_e( $monthname_class ); 
					?>" href="<?php _e( esc_url( admin_url( $menu_path .'page=xllentech_options_tab3') ) ); ?>">
			<?php esc_attr_e( 'Month Names', 'xllentech-calendar' ); ?></a>
			
			<a class="<?php 
				_e( $monthdays_class ); 
					?>" href="<?php _e( esc_url( admin_url( $menu_path .'page=xllentech_options_tab2') ) ); ?>">
			<?php esc_attr_e( 'Month Days', 'xllentech-calendar' ); ?></a>
			
			<a class="<?php 
				_e( $troubleshooting_class ); 
					?>" href="<?php _e( esc_url( admin_url( $menu_path .'page=xllentech_options_tab4') ) ); ?>">
			<?php esc_attr_e( 'Troubleshooting', 'xllentech-calendar' ); ?></a>

			<?php if( is_plugin_active( 'xllentech-calendar-pro/xllentech-calendar-pro.php' ) ) { ?>
			<a class="<?php 
				_e( $pro_options_class ); 
					?> xllentech_pro_tab" href="<?php _e( esc_url( admin_url( $menu_path .'page=xllentech_pro_options') ) ); ?>">
			<?php esc_attr_e( 'PRO Options', 'xllentech-calendar' ); ?></a>
			<?php } ?>
			
			<?php if( is_plugin_active( 'xllentech-datepicker/xllentech-datepicker.php' ) ) { ?>
			<a class="<?php 
				_e( $datepicker_class ); 
					?> xllentech_datepicker_tab" href="<?php _e( esc_url( admin_url( $menu_path .'page=xllentech_datepicker_options') ) ); ?>">
			<?php esc_attr_e( 'Datepicker Options', 'xllentech-calendar' ); ?></a>
			<?php } ?>
