...
?>
<div>
	<center><h2 style="color:#999;font-size:18px;line-height:26px;font-weight:bold">XllenTech Calendar <?php esc_attr_e( XC_PLUGIN_VERSION ); ?></h2></center>
	</center>
</div>
...
<div style="clear:right">
	<span class="button-primary" style="color:#fff;float:right;margin-bottom:10px"><?php if ( is_plugin_active( 'xllentech-datepicker/xllentech-datepicker.php' ) ) _e('Installed & Active'); else _e('<a href="https://www.xllentech.com/wp-plugins/english-islamic-datepicker/" style="color:#fff;text-decoration:none" target="_blank">View Demo/Buy</a>'); ?></span>
</div>