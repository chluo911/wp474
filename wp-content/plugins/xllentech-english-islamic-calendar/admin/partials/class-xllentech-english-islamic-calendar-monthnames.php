				...
				<div class="meta-box-sortables ui-sortable" id="normal-sortables">
							...
							<form method="post" action="#">
								<ul class="xllentech-month-names">
									<li>
										...
										<input type="text" required name="islamic_months1" value="<?php _e( $islamic_months[1] ); ?>" />
									</li>
									<li>
										<label for="islamic_months2">2</label>
										<input type="text" required name="islamic_months2" value="<?php _e( $islamic_months[2] ); ?>" />
									</li>
									<li>
										<label for="islamic_months3">3</label>
										<input type="text" required name="islamic_months3" value="<?php _e( $islamic_months[3] ); ?>" />
									</li>
									<li>
										<label for="islamic_months4">4</label>
										<input type="text" required name="islamic_months4" value="<?php _e( $islamic_months[4] ); ?>" />
									</li>
									<li>
										<label for="islamic_months5">5</label>
										<input type="text" required name="islamic_months5" value="<?php _e( $islamic_months[5] ); ?>" />
									</li>
									<li>
										<label for="islamic_months6">6</label>
										<input type="text" required name="islamic_months6" value="<?php _e( $islamic_months[6] ); ?>" />
									</li>
									<li>
										<label for="islamic_months7">7</label>
										<input type="text" required name="islamic_months7" value="<?php _e( $islamic_months[7] ); ?>" />
									</li>
									<li>
										<label for="islamic_months8">8</label>
										<input type="text" required name="islamic_months8" value="<?php _e( $islamic_months[8] ); ?>" />
									</li>
									<li>
										<label for="islamic_months8">9</label>
										<input type="text" required name="islamic_months9" value="<?php _e( $islamic_months[9] ); ?>" />
									</li>
									<li>
										<label for="islamic_months10">10</label>
										<input type="text" required name="islamic_months10" value="<?php _e( $islamic_months[10] ); ?>" />
									</li>
									<li>
										<label for="islamic_months11">11</label>
										<input type="text" required name="islamic_months11" value="<?php _e( $islamic_months[11] ); ?>" />
									</li>
									<li>
										<label for="islamic_months12">12</label>
										<input type="text" required name="islamic_months12" value="<?php _e( $islamic_months[12] ); ?>" />
									</li>
									<li style="width:100%">
					...
					<div class="postbox " id="section2">
						...
						<div class="inside">
							...
							<form method="post" action="#">
								<ul class="xllentech-month-names">
								<li><label for="english_months1">1</label><input type="text" required name="english_months1" value="<?php _e( $english_months[1] ); ?>" /></li>
								<li><label for="english_months2">2</label><input type="text" required name="english_months2" value="<?php _e( $english_months[2] ); ?>" /></li>
								<li><label for="english_months3">3</label><input type="text" required name="english_months3" value="<?php _e( $english_months[3] ); ?>" /></li>
								<li><label for="english_months4">4</label><input type="text" required name="english_months4" value="<?php _e( $english_months[4] ); ?>" /></li>
								<li><label for="english_months5">5</label><input type="text" required name="english_months5" value="<?php _e( $english_months[5] ); ?>" /></li>
								<li><label for="english_months6">6</label><input type="text" required name="english_months6" value="<?php _e( $english_months[6] ); ?>" /></li>
								<li><label for="english_months7">7</label><input type="text" required name="english_months7" value="<?php _e( $english_months[7] ); ?>" /></li>
								<li><label for="english_months8">8</label><input type="text" required name="english_months8" value="<?php _e( $english_months[8] ); ?>" /></li>
								<li><label for="english_months9">9</label><input type="text" required name="english_months9" value="<?php _e( $english_months[9] ); ?>" /></li>
								<li><label for="english_months10">10</label><input type="text" required name="english_months10" value="<?php _e( $english_months[10] ); ?>" /></li>
								<li><label for="english_months11">11</label><input type="text" required name="english_months11" value="<?php _e( $english_months[11] ); ?>" /></li>
								<li><label for="english_months12">12</label><input type="text" required name="english_months12" value="<?php _e( $english_months[12] ); ?>" /></li>
