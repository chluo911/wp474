	...
	private function display_uninstall_main(){
     ...
     <?php wp_nonce_field('uninstall_polls','uninstall_polls_bad'); ?>
      <div class="wrap">
        ...
        <p>
          Deactivating Polls plugin doesn't remove any data that have been created by plugin in your website database. To completely remove this plugin(with plugin database), you can uninstall it here.
        </p>
