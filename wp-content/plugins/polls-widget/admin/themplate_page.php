...
/*############  Update Poll ID function  ################*/
	
	private function update_poll($id){
		global $wpdb;
		$name=isset($_POST['poll_name'])?sanitize_text_field($_POST['poll_name']):'unnamed';
		$_POST['parametrs']['poll_background_color'] = '#ffffff';
		$_POST['parametrs']['poll_background_color_hower'] = '#ffffff';
		$_POST['parametrs']['poll_background_opacity'] = '73';
		$_POST['parametrs']['poll_background_opacity_hower'] = '65';
...
.poll_span_voted_count{
	...
	display: none;
			...
			/* opacity background*/
				...
				jQuery(document).ready(function(e) {
						...
						jQuery('#poll_align').click(function(){
							alert(text_of_upgrate_version);
							return false;
						});
                        ...
                        <table class="all_options_panel_table wp-list-table widefat fixed posts">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                     ...
                                     <td rowspan="10000"  style="background-color:#FFFFFF">
                                        ...
                                        <div class="main_div_of_the_poll_answer" id="main_of_the_answer_1" title="Answer1">
                                   		...
                                   		<a target="_blank" class="update_pro" href="https://wpdevart.com/wordpress-polls-plugin/"><span style="color: #7052fb; font-weight: bold; font-size: 21px;">Upgrade to Pro Version</span></a>
                                    </td>
                                </tr>
								...
								<tr class="pro_paramets">
                                    <td>
                                   	 	Poll position  <span class="pro_subtitle_span">Pro feature!</span>  <span title="Choose the Poll position" class="desription_class">?</span>
                                    </td>
                                    <td>
                                   <?php 
                                   		 $this->select_align_with_label('poll_align',isset($poll_parametrs['poll_align'])?$poll_parametrs['poll_align']:"left"); ?> 
                                    </td>
                                    <td>
                             ...
                             <tr class="pro_paramets">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class='disabled_for_pro'>
											<div class="wp-picker-container disabled_picker">
												<button type="button" class="button wp-color-result" aria-expanded="false" style="background-color: rgb(175, 175, 175);"><span class="wp-color-result-text">Select Color</span></button>
											</div>                                    
                                        </div>
                                    </td>
                                     <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class='disabled_for_pro'>
											<div class="wp-picker-container disabled_picker">
												<button type="button" class="button wp-color-result" aria-expanded="false" style="background-color: rgb(12, 1, 1);"><span class="wp-color-result-text">Select Color</span></button>
											</div>                                    
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class='disabled_for_pro'>
											<div class="wp-picker-container disabled_picker">
												<button type="button" class="button wp-color-result" aria-expanded="false" style="background-color: rgb(59, 89, 152);"><span class="wp-color-result-text">Select Color</span></button>
											</div>                                    
                                        </div>
                                    </td>
                                     <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class='disabled_for_pro'>
											<div class="wp-picker-container disabled_picker">
												<button type="button" class="button wp-color-result" aria-expanded="false" style="background-color: rgb(135, 135, 135);"><span class="wp-color-result-text">Select Color</span></button>
											</div>                                   
                                        </div>
                                    </td>
                                     <td>
	...
	private function align_types(){
		$align_types[ 'left' ] = 'Left';
		$align_types[ 'center' ] = 'Center';
		$align_types[ 'right' ] = 'Right';
		return $align_types;
	}
	...
	private function select_align_with_label($select_name,$main_value='',$bind=''){
		?>
		<select class="poll_select" name="<?php echo 'parametrs['.$select_name.']'; ?>" id="<?php echo $select_name ?>" >
		<?php
		
		foreach($this->align_types() as $key => $value){
			?>
			<option <?php selected($key,$main_value) ?> value="<?php echo $key ?>"><?php echo $value ?></option>
			<?php 					
		}
